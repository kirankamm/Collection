...
public class Customer implements Comparable<Customer> {
	...
	return"Customer (customerName="+this.customerName+",customerId="+this.customerId+",customerMobileNo="+
	this.customerMobileNo+",customerPlace="+this.customerPlace+",customerAge="+this.customerAge+")";
	}
